<%@ Page Title="" Language="C#" MasterPageFile="sub.master" AutoEventWireup="true"
    CodeFile="OfficeVisitUpdate_Short.aspx.cs" Inherits="DictationConsole_OfficeVisitUpdate_Short"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#<%= txtMelatonin.ClientID %>').filter_input({ regex: '[0-9]' });
            $('#<%= txtHours.ClientID %>').filter_input({ regex: '[0-9]' });
        });
    ...
    <table id="MainTable" runat="server" class="border" width="1050px">
        <tr class="border">
            <td valign="top">
				...
				<asp:TextBox ID="txtDHEA" runat="server" Columns="10" CssClass="FormField" MaxLength="1000" /><br />
            </td>
            <td valign="top">
                <b>For Men Only:</b><br />
        ...
        <tr>
            <td valign="top" align="center" style="border-right: 1px solid #003366;">
                <obout:Grid ID="grdNew" runat="server" ShowLoadingMessage="false" AllowPaging="false"
                    ...
                    ViewStateMode="Enabled" CallbackMode="true">
                    <Columns>
                        <obout:Column AllowEdit="true" Width="100px">
                         
                               <TemplateSettings TemplateId="editButtonTemplate" EditTemplateId="updateButtonTemplate" />
                        </obout:Column>
                        <obout:Column DataField="Symptom" HeaderText="Symptoms" ReadOnly="false" Width="250px">
            ...
            <td valign="top" align="center">
                <obout:Grid ID="grdGoals" runat="server" ShowLoadingMessage="false" AllowPaging="false"
                    ...
                    <Columns>
                        ...
                        <obout:Column DataField="Symptom" HeaderText="Goals" ReadOnly="false" Width="250px">
                        ...
                        <obout:Column DataField="RowPosition" Visible="false" ReadOnly="true" />
                        <obout:Column DataField="Resolved" Visible="false" ReadOnly="true" />
                        <obout:Column ID="Column2" DataField="dir" HeaderText="Change" runat="server" Width="125px"
                            ReadOnly="true">
        ...
        <tr>
            <td valign="top" align="center">
                ...
                <table cellpadding="6" cellspacing="6" width="530px" class="regText" style="background-image: url(../images/export/beige_back.gif); border-style: solid; border-color: Gray; border-width: thin;"
                    frame="box" rules="all">
                    <tr>

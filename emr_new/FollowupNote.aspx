<%@ Page Title="" Language="C#" MasterPageFile="~/sub.master" AutoEventWireup="true"
    CodeFile="FollowupNote.aspx.cs" Inherits="FollowupNote" %>
    ...
    <div>
        ...
        <table width="600" border="0" cellpadding="6" cellspacing="0" class="border">
            <tr bgcolor="#D6B781" class="regText">
                <td bgcolor="#D6B781">
                    <span class="style1"><strong>Appointment - General Follow Up Note Entry </strong>
                    </span>
                </td>
                <td bgcolor="#D6B781">
                    <div align="right">
       ...
       <obout:Editor PathPrefix="Editor_data/" ID="ed" runat="server" Appearance="custom"
		...
		AjaxWait="true" Height="400" Width="600" SpellCheckAutoComplete="true" InitialCleanUp="false">
		<Buttons>

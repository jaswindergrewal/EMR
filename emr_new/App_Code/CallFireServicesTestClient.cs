...
/// <summary>
/// Summary description for CallFireServicesTestClient
/// </summary>
public class CallFireServicesTestClient : System.Web.UI.Page
{
    public class PostSubmitter
    {
        ...
        {
            Console.WriteLine("Inside PostSubmitter Constructor");
        }
        ...
        private string PostData(string url, string postData)
        {
            ...
            {
                Uri uri = new Uri(url);
                Console.WriteLine("Inside PostData");

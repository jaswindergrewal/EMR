...
public partial class AptOvuTab : System.Web.UI.Page
{
    #region "Variables"
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (rdoWater.SelectedItem != null) lfe.IntakeType = GetCheckBoxes(rdoWater);
            if (rdoWaterSource.SelectedItem != null) lfe.IntakeType = GetCheckBoxes(rdoWater);
    ...
    protected void Populate()
    {
        try
        {
            ...
            foreach (var item in _listOfficeVisit)
            {
                ...
                SetCheckBoxList(rdoWater, item.IntakeType);
                SetCheckBoxList(rdoWaterSource, item.WaterSource);
                ...
                SetCheckBoxList(rdoWater, item.WaterSource);

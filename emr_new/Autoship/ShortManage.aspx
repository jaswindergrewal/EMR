<%@ Page Title="Autoship" Language="C#" MasterPageFile="sub.master" AutoEventWireup="true"
    CodeFile="ShortManage.aspx.cs" Inherits="_ShortManage" EnableEventValidation="false" %>

<%@ Register Assembly="obout_Grid_NET" Namespace="Obout.Grid" TagPrefix="obout" %>
<%@ Register Assembly="NineRays.WebControls.FlyTreeView" Namespace="NineRays.WebControls"
    TagPrefix="NineRays" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register TagName="PatientTree" TagPrefix="Longevity" Src="~/Controls/ShortPatientTree.ascx" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <cc1:TabContainer ID="Container" runat="server" CssClass="lmc_tab">
                ...
                <asp:UpdatePanel ID="upPpanel1" runat="server">
                    <ContentTemplate>
                                ...
                                <tr>
                                    <td width="100%">
                                        ...
                                        <asp:Button ID="btnEmail" runat="server" Text="Send Email" OnClick="btnEmail_Click"
                                            CssClass="button" />
                                        <input id="btnPrint" value="Print" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; color: #FFFFFF; background-color: #003366; border: 1px solid #003366; width: 35px; text-align: center"
                                            onclick="window.open('PrintOrder.aspx?PatientID=<%= Request.QueryString["PatientID"] %>')"
                                            width="30px" />
                                        <input id="btnHistory" value="History" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; color: #FFFFFF; background-color: #003366; border: 1px solid #003366; width: 35px; text-align: center"
                                            onclick="window.open('OrderHistory.aspx?PatientID=<%= Request.QueryString["PatientID"] %>')"
                                            width="30px" />
                                        <asp:Button ID="btnQuit" runat="server" Text="Quit Autoship" CssClass="button" OnClick="btnQuit_Click" />
                                        <asp:Button ID="btnOneTime" runat="server" Text="One Time Order" CssClass="button" OnClick="btnOneTime_Click" Visible="false" />
                                        <asp:CheckBox ID="chkCallBeforeShip" Text="Call Before Ship" runat="server" AutoPostBack="true" OnCheckedChanged="chkCallBeforeShip_CheckedChanged" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <table cellpadding="2" cellspacing="2" style="background-image: url(../images/export/beige_back.gif);">
                            <tr>
                                <th class="largeheading">Available items
                                </th>
                                <th class="largeheading">Current orders<br />
                        ...
                        <div class="persist" style="background-color: Transparent; padding-left: 0px;">
                            <table>
                                <tr>
                                    <td valign="top">
                                        <div class="ProductList">
                                            <NineRays:FlyTreeView ID="SupplimentList" runat="server" Padding="3px" FadeEffect="True"
                                                BackColor="White" DragDropName="" DragDropMode="Copy" BackgroundImage="~/images/export/beige_back.gif"
                                                ExpandLevel="2" CssClass="regText">
                                                <HoverStyle Font-Underline="True" />
                                            </NineRays:FlyTreeView>
                            ...
                            <%--<obout:Grid ID="grdSupps" runat="server" ShowLoadingMessage="false" AllowPaging="false"
											...
											AllowPageSizeSelection="false" Serialize="false" Width="800px" CellPadding="3"
											CallbackMode="true" CellSpacing="3" CSSFolderImages="resources/custom-styles/persist"
											>
											<Columns>
												
												
												<obout:Column HeaderText="Supplement" DataField="SuppName" Width="800px" Wrap="true" />
                        ...
                        <NineRays:FlyContextMenu ID="ItemMenu" runat="server" OnCommand="ItemMenu_Command">
                            <Items>
                                ...
                                <NineRays:FlyMenuItem Text="Affiliate Sale" CommandName="Affiliate" AutoPostBack="true" />
                            </Items>
                        ...
                        <NineRays:FlyContextMenu ID="GroupMenu" runat="server" OnCommand="GroupMenu_Command">
                            <Items>
                                ...
                                <NineRays:FlyMenuItem Text="Hold" CommandName="Hold" AutoPostBack="true" />
                            </Items>
                        </NineRays:FlyContextMenu>
                        <NineRays:FlyContextMenu ID="GroupMenuNew" runat="server" OnCommand="GroupMenuNew_Command">
                            <Items>
                                <%--<NineRays:FlyMenuItem Text="Cancel the entire shipment" CommandName="Cancel" AutoPostBack="true" />
								<NineRays:FlyMenuItem Text="Modify Frequency or Due Date" CommandName="Modify" AutoPostBack="true" />--%>
                                <NineRays:FlyMenuItem Text="UnHold" CommandName="UnHold" AutoPostBack="true" />
                            </Items>
                        </NineRays:FlyContextMenu>
                        ...
                        <NineRays:FlyContextMenu ID="NoExceptionEdit" runat="server">
                            <Items>
                                <NineRays:FlyMenuItem Text="Cannot edit when group has exceptions." />
                            </Items>
                        </NineRays:FlyContextMenu>
                        ...
                        <cc1:ModalPopupExtender ID="modGetAdress" BackgroundCssClass="ModalPopupBG" runat="server"
                            CancelControlID="btnCancelEmail" TargetControlID="dummy5" PopupControlID="pnlGetEmailAddress"
                            Y="200" />
                        <asp:Panel ID="pnlGetEmailAddress" runat="server" CssClass="modalPopup" Width="300px"
                            DefaultButton="btnCancelEmail">
                            <div class="popup_Container">
                                ...
                                <div class="popup_Body">
                                    ...
                                    <asp:TextBox ID="txtEmailAddress" runat="server" CausesValidation="true" />
                                </div>
                        ...
                        <cc1:ModalPopupExtender ID="modCreateGroup" BackgroundCssClass="ModalPopupBG" runat="server"
                            CancelControlID="btnCancelCreate" TargetControlID="btnCreateGroup" PopupControlID="pnlCreateGroup"
                            Y="200" />
                        <asp:Panel ID="pnlCreateGroup" CssClass="modalPopup" Width="250px" runat="server"
                            DefaultButton="btnOkayCreate">
                            <div class="popup_Container">
                                ...
                                <div class="popup_Buttons">
                                    ...
                                    <asp:CompareValidator ID="valFuture" runat="server" Operator="GreaterThanEqual" ValueToCompare=""
                                        ErrorMessage="Due Date cannot be smaller than current date." ControlToValidate="txtNextDue"
                                        Type="Date" EnableClientScript="true" Display="Dynamic" ForeColor="Red" />
                        ...
                        <cc1:ModalPopupExtender ID="modConfirmDelete" runat="server" BackgroundCssClass="ModalPopupBG"
                            CancelControlID="btnCancelDelete" TargetControlID="btnDummy" PopupControlID="pnlDeleteGroup"
                            Y="200" />
                        <asp:Panel ID="pnlDeleteGroup" runat="server" CssClass="modalPopup" Width="250px"
                            DefaultButton="btnOkDelete">
                            <div class="popup_Container">
                        ...
                        <asp:Button ID="dummyQuit" runat="server" Style="display: none" />
                        <cc1:ModalPopupExtender ID="modReason" BackgroundCssClass="ModalPopupBG" runat="server"
                            CancelControlID="btnCancelQuit" TargetControlID="dummyQuit" PopupControlID="pnlQuit"
                            Y="200" />
                        <asp:Panel ID="pnlQuit" CssClass="modalPopup" Width="700px" runat="server" DefaultButton="btnOkQuit"
                            Style="position: relative; top: 200px;">
                            <div class="popup_Container">
                                <div class="popup_Titlebar">
                                    <div class="TitlebarLeft">
                                        Reasons for quitting Autoship
                                    </div>
                                </div>
                                <div class="popup_Body">
                                    <asp:RadioButtonList ID="rdoReason" runat="server" RepeatDirection="Vertical">
                                    </asp:RadioButtonList>
                                    <asp:TextBox ID="txtOther" runat="server" />
                                </div>
                                <div class="popup_Buttons">
                                    <asp:Button ID="btnOkQuit" Text="Done" CssClass="button" runat="server" OnClick="btnOkQuit_Click" />
                                    <asp:Button ID="btnCancelQuit" Text="Cancel" CssClass="button" runat="server" />
                                </div>
                            </div>
                        </asp:Panel>
                        ...
                        <cc1:ModalPopupExtender ID="ModalAlert" BackgroundCssClass="ModalPopupBG" runat="server"
                            CancelControlID="btnCancel" TargetControlID="dummy" PopupControlID="Panel1"
                            Y="200" />
                        <asp:Panel ID="Panel1" CssClass="modalPopup" Width="700px" runat="server"
                            ...
                            <div class="popup_Container">
                                ...
                                <div class="popup_Body">
                                    Call customer service and does not cancel when the last order state is not complete.
                                </div>
                                <div class="popup_Buttons">
        ...
        <cc1:TabPanel ID="FuturePanel" runat="server" HeaderText="Upcoming Shipments" CssClass="TabPanel" Visible="false">
            <ContentTemplate>
                <asp:UpdatePanel ID="upPpanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <div id="Div1" style="background-image: url(../images/export/boxmenu_large.gif); layer-background-image: url(../images/export/boxmenu_large.gif); border: 1px none #000000; width: 600px;">
                        ...
                        <table cellpadding="2" cellspacing="2" style="background-image: url(../images/export/beige_back.gif);">
                            <tr>
                                ...
                                <th class="largeheading">Upcoming shipments<br />
                        ...
                        <cc1:ModalPopupExtender ID="modShipDate" BackgroundCssClass="ModalPopupBG" runat="server"
                            CancelControlID="btnCancelShip" TargetControlID="dummy6" PopupControlID="pnlShipDate"
                            Y="200" />
                        ...
                        <cc1:ModalPopupExtender ID="modAddress" BackgroundCssClass="ModalPopupBG" runat="server"
                            CancelControlID="btnCancelAddress" TargetControlID="dummy3" PopupControlID="pnlAddress"
                            Y="200" />
    ...
    <cc1:ModalPopupExtender ID="modDiscount" runat="server" BackgroundCssClass="ModalPopupBG"
        CancelControlID="btnCancelDiscount" TargetControlID="btnDummy1" PopupControlID="pnlDiscount"
        Y="200" />
    <asp:Panel ID="pnlDiscount" runat="server" CssClass="modalPopup" Width="250px" DefaultButton="btnOkDiscount" Style="display: none;">
        <div class="popup_Container">
            <div class="popup_Titlebar">
                <div class="TitlebarLeft">
                    Modify Discount

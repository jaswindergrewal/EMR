...
public class Utilities
{
    ...
    public static void SendSurveyMessage(string toAddress, string toName, string Subject,int PatientID,int ApptID)
    {
        //var IfromAddress = new MailAddress("contactus@LongevityMedicalClinic.com", "Tickets");
        ...
        //{
        //    conn.Open();
        //    SqlCommand cmd = new SqlCommand("select * from EmailTemplate", conn);

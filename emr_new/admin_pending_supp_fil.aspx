<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
	CodeFile="admin_pending_supp_fil.aspx.cs" Inherits="admin_pending_pre_fil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<%--<asp:SqlDataSource ID="sqlClinic" runat="server" SelectCommand="select ClinicID, ClinicName from clinics order by ClinicName" />--%>
</asp:Content>

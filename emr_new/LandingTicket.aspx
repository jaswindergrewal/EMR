<%@ Page Title="" Language="C#" MasterPageFile="~/sub.master" AutoEventWireup="true" CodeFile="LandingTicket.aspx.cs" Inherits="LandingTicket" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <ul class="tabs">
            <li id="liGeneralTab"><a href="#" id="lnkGeneralTab" runat="server" clientidmode="Static" onclick="BindTicketData('#grdActiveTickets1','#pagernav1','1')">Active Tickets</a></li>
            <li><a href="#" runat="server" id="lnkGroupTickets" clientidmode="Static" onclick="BindTicketData('#grdGroupTickets2','#pagernav2','2')">Group Tickets Due Now</a></li>
            <li><a href="#" runat="server" id="lnkFutureTickets" clientidmode="Static" onclick="BindTicketData('#grdFutureTickets3','#pagernav3','3')">My Future Tickets</a></li>
            <li><a href="#" runat="server" id="lnkGroupFuture" clientidmode="Static" onclick="BindTicketData('#grdGroupFuture4','#pagernav4','4')">Group Future Tickets</a></li>
            <li><a href="#" runat="server" id="lnkActiveICreated" clientidmode="Static" onclick="BindTicketData('#grdActiveICreated5','#pagernav5','5')">Active Tickets I Created</a></li>
            <li><a href="#" runat="server" id="lnkClosedICreated" clientidmode="Static" onclick="BindTicketData('#grdClosedICreated6','#pagernav6','6')">Closed Tickets I Created</a></li>
    ...
    <div class="uiform">
        <div id="Div2" class="panes" >
            <div id="GeneralInfo">
                <table id="grdActiveTickets1"></table>

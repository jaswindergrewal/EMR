...
public partial class OpenInvoices : LMCBase
{
	...
	protected void Page_Load(object sender, EventArgs e)
    {
		...
		if (!IsPostBack)
		{
            ...
            //ReportViewer1.ServerReport.ReportPath = "/EMR/Open Invoices";
            ...
            //var patient = ctx.Patient_Details(int.Parse(ReportViewer1.ServerReport.GetParameters().First().Values[0])).First();

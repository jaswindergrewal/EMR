<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/sub.master" CodeFile="prescription_history.aspx.cs" Inherits="prescription_history" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function BindData1() {
            ...
            $.ajax({
                type: "POST",
                url: "prescription_history.aspx/BindData",
                    ...
                    if (listObj != null) {
                        ...
                        for (var i = 0 ; i < listObj.length; i++) {
                            if (drugName != listObj[i].DrugName) {
                                ...
                                $("#PrescriptionLayer1").append('<table width="100%" border="0" cellpadding="6" cellspacing="0" bgcolor="#D6B781" >' +
                                   "<tr bgcolor='#D6B781'>" +
                            ...
                            if (listObj[i].Closed_YN != 0) {
                                $("#PrescriptionLayer1").append("<div style='width:270 px;padding-left:6px; overflow-x: auto;'>" +
                                    "<table border='0'  cellpadding='6' cellspacing='0' class='border'>" +
                                    "<tr>" +
                                    "<td width='270'>" +
                                    "<font color='999999'>" +
                                    "<strong>Date Prescribed</strong>: " + convertDate(listObj[i].Drug_DatePrescibed) + "<br>" +
                                    "<strong>Sig</strong>: " + listObj[i].Drug_Dose + "<br>" +
                                    "<strong>Dispenses</strong>: " + listObj[i].Drug_Dispenses + "<br>" +
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="PrescriptionLayer1" style="position: absolute; z-index: 2;  top: 72px; width: 706px; background-color: #D6B781;">
    </div>

...
public partial class LandingPage : LMCBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //              if (Convert.ToInt32(Request.QueryString["gridFill"]) <= 6 && Convert.ToInt32(Request.QueryString["Isticket"]) == 1)
        //              {
        //                  strTicketData = BindTiketGrid((int)Session["StaffID"], Request.QueryString["gridFill"], _search, nd, rows, page, sidx, sord);
        //              }
        //              else
        //              {
        //                  strTicketData = BindCalendarGrid((int)Session["StaffID"], Request.QueryString["gridFill"], _search, nd, rows, page, sidx, sord);
        //              }
    ...
    public static int SetSession(int SessionValue)
    {
        if (SessionValue != 0)
    ...
    //public string BindCalendarGrid(int staffID, string GrdTab, string _search, string nd, int rows, int page, string sidx, string sord)
    //{
    ...
    //        {
    //            intTotalPages = lstTickets[0].RecordCount;

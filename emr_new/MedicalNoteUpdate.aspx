<%@ Page Title="Edit Medical Note" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true"
	CodeFile="MedicalNoteUpdate.aspx.cs" Inherits="MedicalNoteUpdate" %>
		...
		<table width="600" border="0" cellpadding="6" cellspacing="0" class="border">
			...
			<tr bgcolor="#D6B781" class="regText">
				...
				<td width="19%" bgcolor="#D6B781">
					<div align="right">
						<input name="Button" type="button" class="button" onclick="MM_goToURL('self','apt_console.aspx?aptid=<%= ApptID %>');return document.MM_returnValue"

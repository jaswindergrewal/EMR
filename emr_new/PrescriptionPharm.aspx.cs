...
public partial class PrescriptionPharm : LMCBase
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!IsPostBack)
		{
            ...
            //ReportViewer1.ServerReport.ReportPath = "/LabReports/PrescriptionPharm";
	...
	{
		if (Request.QueryString["FullScreen"] == "no")
		{
			Response.Redirect("PresrcriptionList.aspx?PatientID=" + Request.QueryString["PatientID"] + "&MasterPage=sub.master");
		}
		else
		{
			Response.Redirect("PresrcriptionList.aspx?PatientID=" + Request.QueryString["PatientID"] + "&AptID=" + Request.QueryString["aptid"]);
		}
	}

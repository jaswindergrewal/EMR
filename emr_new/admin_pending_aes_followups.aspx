<%@ Page Language="C#" Title="Pending Follow Up" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="admin_pending_aes_followups.aspx.cs" Inherits="admin_pending_aes_followups" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	<p class="PageTitle">
		Pending Follow Up Requests</p>

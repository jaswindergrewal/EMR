...
/// </summary>
public partial class problem_diag_edit : LMCBase
{
    #region "Variables"
    ...
    /// <summary>
    /// Get the problemdiagnosis data on the basis of diagnosis id
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
        ...
        if (!IsPostBack)
        {
            try
            {
                if (Request.QueryString["ProbDiagID"] != null)
                {
                    ...
                    Diag = objService.GetProblemDiagnosisList(int.Parse(Request.QueryString["ProbDiagID"]));
                    if (Diag != null)
                    {
    ...
    /// <summary>
    /// Update the Servity and priority of the problem diagnosis.
    /// </summary>
    /// <param name="sender"></param>
    /// <param name="e"></param>
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objService = new ProblemListService();
            objService.UpdateProblemDiagList(int.Parse(Request.QueryString["ProbDiagID"]), decimal.Parse(ddlPri.SelectedValue), decimal.Parse(ddlSev.SelectedValue));

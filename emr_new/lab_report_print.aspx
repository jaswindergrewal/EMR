<%@ Page Title="" Language="C#" MasterPageFile="~/sub.master" AutoEventWireup="true" CodeFile="lab_report_print.aspx.cs" Inherits="lab_report_print" %>
...
<table border="0" width="100%" class="labreportprint">
	<tr>
		<td width="33%" nowrap align="left"><b>Test Name</b></td>
		<td width="10%" nowrap align="left"><b>In Range</b></td>
		<td width="20%" nowrap align="left"><b>Out of Range</b></td>
		<td width="23%" nowrap align="left"><b>Reference Range</b></td>
		<td width="14%" nowrap align="left"><b>Lab</b></td>
	</tr>
    <tr>
        <td width="33%"><asp:Label ID= "lblTestName" runat="server"></asp:Label></td>
        <td width="10%"></td>
        <td width="20%"></td>
        <td width="23%"></td>
        <td width="14%"><asp:Label ID="lblLabId" runat="server"></asp:Label></td>
     </tr>
